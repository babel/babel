...
(() => {
  [_init_a, _init_a2, _get_a, _set_a, _init_computedKey, _init_computedKey2, _init_computedKey3, _init_computedKey4, _init_computedKey5, _init_computedKey6, _init_computedKey7, _initStatic] = babelHelpers.applyDecs2203(Foo, [[dec, 6, "a"], [dec, 6, "a", function () {
  ...
  }], [dec, 6, "b"], [dec, 6, _computedKey], [dec, 6, "0"], [dec, 6, _computedKey2], [dec, 6, "2"], [dec, 6, _computedKey3], [dec, 6, _computedKey4]], []);
  _initStatic(Foo);
})();
var _A = {
  writable: true,
...
var _C = {
  writable: true,
  value: _init_computedKey(Foo)
};
var _D = {
  writable: true,
  value: _init_computedKey2(Foo)
};
var _E = {
  writable: true,
  value: _init_computedKey3(Foo)
};
var _F = {
  writable: true,
  value: _init_computedKey4(Foo)
};
var _G = {
  writable: true,
  value: _init_computedKey5(Foo)
};
var _H = {
  writable: true,
  value: _init_computedKey6(Foo)
};
var _I = {
  writable: true,
  value: _init_computedKey7(Foo)
};
