...
class C {
    ...
    static {
      (class {
        static {
          ...
          [_init_computedKey, _initStatic, _decorated_class8, _initClass10] = babelHelpers.applyDecs(this, [[dec, 6, "7"]], [dec]);
          _initStatic(this);
        }
        static get 7() {
          return this.#A;
  ...
  static #J = (class {
    static {
      ...
      [_decorated_class10, _initClass12] = babelHelpers.applyDecs(this, [], [dec]);
    }
    static {
      _initClass12();
    }
