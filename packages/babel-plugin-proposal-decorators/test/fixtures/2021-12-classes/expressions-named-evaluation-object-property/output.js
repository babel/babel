...
({
    ...
    static {
      (class {
        static {
          ...
          [_decorated_class3, _initClass4] = babelHelpers.applyDecs(this, [], [dec]);
        }
      });
    }
    constructor() {
  ...
  2: (class extends class {} {
    static {
      ...
      [_decorated_class4, _initClass5] = babelHelpers.applyDecs(this, [], [dec]);
    }
    static {
      _initClass5();
    }
    ...
    static {
      (class extends class {} {
        static {
          ...
          [_decorated_class5, _initClass6] = babelHelpers.applyDecs(this, [], [dec]);
        }
      });
    }
    constructor() {
  ...
  [_ = "4"]: (class {
    static {
      ...
      [_decorated_class6, _initClass7] = babelHelpers.applyDecs(this, [], [dec]);
    }
    p;
    static {
      _initClass7();
  ...
  [_2 = 5]: (class {
    static {
      ...
      [_decorated_class7, _initClass8] = babelHelpers.applyDecs(this, [], [dec]);
    }
    p;
    static {
      _initClass8();
  ...
  [_3 = 6n]: (class {
    static {
      ...
      [_decorated_class8, _initClass9] = babelHelpers.applyDecs(this, [], [dec]);
    }
    p;
    static {
      _initClass9();
    ...
    static {
      (class {
        static {
          ...
          [_init_computedKey, _decorated_class9, _initClass10] = babelHelpers.applyDecs(this, [[dec, 5, "7"]], [dec]);
        }
      });
    }
  ...
  [_Symbol = Symbol(9)]: (class {
    static {
      ...
      [_decorated_class10, _initClass11] = babelHelpers.applyDecs(this, [], [dec]);
    }
    p;
    static {
      _initClass11();
