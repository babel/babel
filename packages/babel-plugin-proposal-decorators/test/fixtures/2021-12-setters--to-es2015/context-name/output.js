...
(() => {
  [_call_a, _initStatic] = babelHelpers.applyDecs(Foo, [[dec, 9, "a"], [dec, 9, "a", function (v) {}], [dec, 9, "b"], [dec, 9, _computedKey], [dec, 9, "0"], [dec, 9, _computedKey2], [dec, 9, "2"], [dec, 9, _computedKey3], [dec, 9, _computedKey4]], []);
  _initStatic(Foo);
})();
