...
class Foo {
  static {
    [_call_a, _initStatic] = babelHelpers.applyDecs2203(this, [[dec, 8, "a"], [dec, 8, "a", function () {}], [dec, 8, "b"], [dec, 8, _computedKey], [dec, 8, "0"], [dec, 8, _computedKey2], [dec, 8, "2"], [dec, 8, _computedKey3], [dec, 8, _computedKey4]], []);
    _initStatic(this);
  }
  static get a() {}
  static get #a() {
