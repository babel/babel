...
class A extends class _Class {
  static {
    [_init___proto__, _initStatic] = babelHelpers.applyDecs2203(this, [[noop, 6, "__proto__"]], []);
    _initStatic(this);
  }
  ...
  static {
    [_init_computedKey] = babelHelpers.applyDecs2203(this, [[noop, 5, "__proto__"]], []);
  }
...
class C {
  static {
    [_init_computedKey3, _init_computedKey4, _init__, _get__, _set__, _init_A, _init_computedKey2, _init__2, _initStatic2] = babelHelpers.applyDecs2203(this, [[noop, 6, "2"], [noop, 6, _computedKey2], [noop, 6, "_4", function () {
      return this.#C;
    }, function (value) {
      this.#C = value;
