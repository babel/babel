    ...
    class Class {
      static {
        ({
          ...
          c: [_Class, _initClass]
        } = babelHelpers.applyDecs2301(this, [[dec, 7, "j"], [dec, 8, "k"], [dec, 9, "l"], [dec, 6, "m"], [dec, 7, "o", function () {}, _ => #o in _], [dec, 8, "p", function () {}, _ => #p in _], [dec, 9, "q", function (v) {}, _ => #q in _], [dec, 6, "r", function () {
          return this.#D;
        }, function (value) {
          this.#D = value;
        }, _ => #D in _], [dec, 2, "b"], [dec, 3, "c"], [dec, 4, "c"], [dec, 1, "d"], [dec, 2, "f", function () {}, _ => #f in _], [dec, 3, "g", function () {}, _ => #g in _], [dec, 4, "g", function (v) {}, _ => #g in _], [dec, 1, "h", function () {
          return this.#B;
        }, function (value) {
          this.#B = value;
        }, _ => #B in _], [dec, 5, "i"], [dec, 5, "n", function () {
          return this.#n;
        }, function (value) {
          this.#n = value;
        }, _ => #n in _], [dec, 0, "a"], [dec, 0, "e", function () {
          return this.#e;
        }, function (value) {
          this.#e = value;
        }, _ => #e in _]], [dec]));
