...
const A = (new (_temp = class extends babelHelpers.identity {
  ...
  class A {}
  [_A, _initClass] = babelHelpers.applyDecs2301(A, [], [dec]).c;
})(), _temp)(), _A);
const B = (new (_temp2 = class extends babelHelpers.identity {
  ...
  class C {}
  [_C, _initClass2] = babelHelpers.applyDecs2301(C, [], [dec]).c;
})(), _temp2)(), _C);
const D = (new (_temp3 = class extends babelHelpers.identity {
  ...
  class D {}
  [_D, _initClass3] = babelHelpers.applyDecs2301(D, [], [dec]).c;
})(), _temp3)(), _D);
...
const F = [(new (_temp5 = class extends babelHelpers.identity {
  ...
  class G {}
  [_G, _initClass5] = babelHelpers.applyDecs2301(G, [], [dec]).c;
...
const H = (new (_temp7 = class extends babelHelpers.identity {
  ...
  class H extends I {}
  [_H, _initClass7] = babelHelpers.applyDecs2301(H, [], [dec]).c;
})(), _temp7)(), _H);
const J = (new (_temp8 = class extends babelHelpers.identity {
  ...
  class K extends L {}
  [_K, _initClass8] = babelHelpers.applyDecs2301(K, [], [dec]).c;
})(), _temp8)(), _K);
