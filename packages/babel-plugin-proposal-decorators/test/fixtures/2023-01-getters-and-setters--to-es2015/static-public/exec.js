...
expect(b_getterContext.access.get(Foo)).toBe(2);
Foo.a = 123;
expect(Foo.a).toBe(125);
expect(Foo.b).toBe(125);
expect(a_getterContext.access.get(Foo)).toBe(125);
expect(b_getterContext.access.get(Foo)).toBe(125);
Foo.b = 456;
expect(Foo.a).toBe(458);
expect(Foo.b).toBe(458);
expect(a_getterContext.access.get(Foo)).toBe(458);
expect(b_getterContext.access.get(Foo)).toBe(458);
a_setterContext.access.set(Foo, 789);
expect(Foo.a).toBe(791);
expect(Foo.b).toBe(791);
expect(a_getterContext.access.get(Foo)).toBe(791);
expect(b_getterContext.access.get(Foo)).toBe(791);
