...
const helpers: Record<string, Helper> = {
  ...
  // size: 2874, gzip size: 1287
  regenerator: helper(
    "7.27.0",
    'function _regenerator(){"use strict";\n/*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */var e,t,r=Object.prototype,n=r.hasOwnProperty,o="function"==typeof Symbol?Symbol:{},i=o.iterator||"@@iterator",a=o.toStringTag||"@@toStringTag",u=["next","throw","return"];function f(r,n,o,i){var a=n&&n.prototype instanceof Generator?n:Generator,f=Object.create(a.prototype);return define(f,"_invoke",function(r,n,o){var i,a,f=1,p=o||[],l=!1,s=0,d=e,v={prev:0,next:0,sent:e,stop:y,abrupt:h,finish:function(e){for(var t=p.length-1;t>=0;--t){var r=p[t];if(r[2]===e)return g(r[4],r[5],r[3]),r[4]=0,c}},delegateYield:function(t,r){return a=values(t),d=e,v.next=r,c}};function y(){return l=!0,i}function G(e){for(var t=p.length-1;!l&&t>=0;--t){var r=p[t],n=v.prev,o=r[1],i=r[2];if(r[0]<=n){if(n<o)return s=0,v.sent=e,void(v.next=o);if(n<i)return r[4]=1,r[5]=e,void(v.next=i)}}throw f=4,e}function h(e,t){for(var r=p.length-1;r>=0;--r){var n=p[r];if(n[0]<=v.prev&&v.prev<n[2]&&!((2===e||3===e)&&n[0]<=t&&t<=n[2])){var o=n;break}}return o?(o[4]=e,o[5]=t,s=0,v.next=o[2],c):g(e,t)}function g(e,t,r){if(1===e)throw t;return 2===e||3===e?v.next=t:4===e?(i=d=t,s=2,v.next=-1):r&&(v.next=r),c}return function(o,i){if(o=u.indexOf(o),3===f)throw Error("Generator is already running");if(4===f){if(1===o)throw i;return{value:e,done:!0}}for(s=o,d=i;;){if(!a)if(0===s)v.sent=d;else if(1===s){if(1===f)throw f=4,d;G(d)}else 2===s&&h(4,d);try{if(a){if(t=a[u[s]]){if(t=t.call(a,d)){if(t||(s=1,d=new TypeError("iterator result is not an object")),!t.done)return t;2!==s&&(s=0,d=t.value)}}else 1===s&&(t=a.return)&&t.call(a),2!==s&&(d=new TypeError("The iterator does not provide a \'"+u[s=1]+"\' method"));a=e}else if(f=3,t=(-1===v.next?y:r).call(n,v),f=l?4:2,t!==c)return{value:t,done:l}}catch(t){f=4,a=e,s=1,d=t}}}}(r,o,i),!0),f}var c={};function Generator(){}function GeneratorFunction(){}function GeneratorFunctionPrototype(){}var p={};define(p,i,(function(){return this}));var l=Object.getPrototypeOf,s=l&&l(l(values([])));s&&s!==r&&n.call(s,i)&&(p=s);var d=GeneratorFunctionPrototype.prototype=Generator.prototype=Object.create(p);function v(e){return Object.setPrototypeOf?Object.setPrototypeOf(e,GeneratorFunctionPrototype):(e.__proto__=GeneratorFunctionPrototype,define(e,a,"GeneratorFunction")),e.prototype=Object.create(d),e}return GeneratorFunction.prototype=GeneratorFunctionPrototype,define(d,"constructor",GeneratorFunctionPrototype),define(GeneratorFunctionPrototype,"constructor",GeneratorFunction),GeneratorFunction.displayName=define(GeneratorFunctionPrototype,a,"GeneratorFunction"),defineIteratorMethods(d),define(d,a,"Generator"),define(d,i,(function(){return this})),define(d,"toString",(function(){return"[object Generator]"})),(_regenerator=function(){return{w:f,m:v}})()}',
    {
