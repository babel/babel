...
const helpers: Record<string, Helper> = {
  ...
  // size: 3260, gzip size: 1443
  regenerator: helper(
    "7.27.0",
    'function _regenerator(){"use strict";\n/*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */var e,r,t=Object.prototype,n=t.hasOwnProperty,o="function"==typeof Symbol?Symbol:{},i=o.iterator||"@@iterator",a=o.toStringTag||"@@toStringTag",f=["next","throw","return"];function u(t,n,o,i){var a=n&&n.prototype instanceof Generator?n:Generator,u=Object.create(a.prototype);return define(u,"_invoke",function(t,n,o){var i=1;function a(r){var t=r[4]||{};t.type=0,t.arg=e,r[4]=t}var u,p,v=[[-1]].concat(o||[]),y=!1,l=0,d=e;v.forEach(a);var s={prev:0,next:0,sent:e,stop:g,abrupt:G,finish:function(e){for(var r=v.length-1;r>=0;--r){var t=v[r];if(t[2]===e)return F(t[4],t[3]),a(t),c}},catch:function(e){for(var r=v.length-1;r>=0;--r){var t=v[r];if(t[0]===e){var n=t[4];if(1===n.type){var o=n.arg;a(t)}return o}}},delegateYield:function(r,t){return p=values(r),d=e,s.next=t,c}};function g(){y=!0;var e=v[0][4];if(1===e.type)throw e.arg;return u}function h(r){if(y)throw r;function t(e){i.type=1,i.arg=r,s.next=e}for(var n=v.length-1;n>=0;--n){var o=v[n],i=o[4],a=s.prev,f=o[1],u=o[2];if(-1===o[0])return void t(-1);if(null!=o[0]&&o[0]<=a){if(a<f)return l=0,d=e,void t(f);if(a<u)return void t(u)}}}function G(e,r){for(var t=v.length-1;t>=0;--t){var n=v[t];if(n[0]>-1&&n[0]<=s.prev&&s.prev<n[2]){var o=n;break}}o&&(2===e||3===e)&&o[0]<=r&&r<=o[2]&&(o=null);var i=o?o[4]:{};return i.type=e,i.arg=r,o?(l=0,s.next=o[2],c):F(i)}function F(e,r){if(1===e.type)throw e.arg;return 2===e.type||3===e.type?s.next=e.arg:4===e.type?(u=d=e.arg,l=2,s.next=-1):0===e.type&&r&&(s.next=r),c}return function(o,a){if(o=f.indexOf(o),3===i)throw Error("Generator is already running");if(4===i){if(1===o)throw a;return{value:e,done:!0}}for(l=o,d=a;;){if(!p)if(0===l)s.sent=d;else if(1===l){if(1===i)throw i=4,d;h(d)}else 2===l&&G(4,d);try{if(p){if(r=p[f[l]]){if(r=r.call(p,d)){if(r||(l=1,d=new TypeError("iterator result is not an object")),!r.done)return r;2!==l&&(l=0,d=r.value)}}else 1===l&&(r=p.return)&&r.call(p),2!==l&&(d=new TypeError("The iterator does not provide a \'"+f[l=1]+"\' method"));p=e}else if(i=3,r=(-1===s.next?g:t).call(n,s),i=y?4:2,r!==c)return{value:r,done:y}}catch(r){i=4,p=e,l=1,d=r}}}}(t,o,i),!0),u}var c={};function Generator(){}function GeneratorFunction(){}function GeneratorFunctionPrototype(){}var p={};define(p,i,(function(){return this}));var v=Object.getPrototypeOf,y=v&&v(v(values([])));y&&y!==t&&n.call(y,i)&&(p=y);var l=GeneratorFunctionPrototype.prototype=Generator.prototype=Object.create(p);function d(e){return Object.setPrototypeOf?Object.setPrototypeOf(e,GeneratorFunctionPrototype):(e.__proto__=GeneratorFunctionPrototype,define(e,a,"GeneratorFunction")),e.prototype=Object.create(l),e}return GeneratorFunction.prototype=GeneratorFunctionPrototype,define(l,"constructor",GeneratorFunctionPrototype),define(GeneratorFunctionPrototype,"constructor",GeneratorFunction),GeneratorFunction.displayName=define(GeneratorFunctionPrototype,a,"GeneratorFunction"),defineIteratorMethods(l),define(l,a,"Generator"),define(l,i,(function(){return this})),define(l,"toString",(function(){return"[object Generator]"})),(_regenerator=function(){return{w:u,m:d}})()}',
    {
