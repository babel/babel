...
const helpers: Record<string, Helper> = {
  ...
  // size: 3382, gzip size: 1507
  regenerator: helper(
    "7.27.0",
    'function _regenerator(){"use strict";\n/*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */var e,r,t=Object.prototype,n=t.hasOwnProperty,o="function"==typeof Symbol?Symbol:{},i=o.iterator||"@@iterator",a=o.toStringTag||"@@toStringTag",u=["next","throw","return"];function f(t,n,o,i){var a=n&&n.prototype instanceof Generator?n:Generator,f=Object.create(a.prototype);return define(f,"_invoke",function(t,n,o){var i=1;function a(r){var t=r[4]||{};t.type=0,t.arg=e,r[4]=t}var f,p=[[-1]].concat(o||[]),v=!1,y=null,l=0,s=e;p.forEach(a);var d={prev:0,next:0,sent:e,stop:h,abrupt:G,finish:function(e){for(var r=p.length-1;r>=0;--r){var t=p[r];if(t[2]===e)return F(t[4],t[3]),a(t),c}},catch:function(e){for(var r=p.length-1;r>=0;--r){var t=p[r];if(t[0]===e){var n=t[4];if(1===n.type){var o=n.arg;a(t)}return o}}},delegateYield:function(r,t,n){return y={i:values(r),r:t,n:n},0===l&&(s=e),c}};function h(){v=!0;var e=p[0][4];if(1===e.type)throw e.arg;return f}function g(r){if(v)throw r;function t(e){i.type=1,i.arg=r,d.next=e}for(var n=p.length-1;n>=0;--n){var o=p[n],i=o[4],a=d.prev,u=o[1],f=o[2];if(-1===o[0])return t(-1),!1;if(null!=o[0]&&o[0]<=a){if(a<u)return l=0,s=e,t(u),!0;if(a<f)return t(f),!1}}}function G(e,r){for(var t=p.length-1;t>=0;--t){var n=p[t];if(n[0]>-1&&n[0]<=d.prev&&d.prev<n[2]){var o=n;break}}o&&(2===e||3===e)&&o[0]<=r&&r<=o[2]&&(o=null);var i=o?o[4]:{};return i.type=e,i.arg=r,o?(l=0,d.next=o[2],c):F(i)}function F(e,r){if(1===e.type)throw e.arg;return 2===e.type||3===e.type?d.next=e.arg:4===e.type?(f=s=e.arg,l=2,d.next=-1):0===e.type&&r&&(d.next=r),c}return function(o,a){if(o=u.indexOf(o),3===i)throw Error("Generator is already running");if(4===i){if(1===o)throw a;return{value:e,done:!0}}for(l=o,s=a;;)if(y){var f=y.i,p=f[u[l]];if(p){if((b=tryCatch(p,f,s)).e)l=1,s=b.v;else{var F=b.v;if(F){if(!F.done)return F;d[y.r]=F.value,d.next=y.n,2!==l&&(l=0,s=e)}else l=1,s=new TypeError("iterator result is not an object")}y=null;continue}y=null,2!==l&&(s=new TypeError("The iterator does not provide a \'"+u[l=1]+"\' method")),1===l&&(r=f.return)&&(b=tryCatch(r,f)).e&&(s=b.v)}else{if(0===l)d.sent=s;else if(1===l){if(1===i)throw i=4,s;g(s)}else 2===l&&G(4,s);var b;if(i=3,!(b=tryCatch(-1===d.next?h:t,n,d)).e){if(i=v?4:2,b.v===c)continue;return{value:b.v,done:v}}i=4,l=1,s=b.v}}}(t,o,i),!0),f}var c={};function Generator(){}function GeneratorFunction(){}function GeneratorFunctionPrototype(){}var p={};define(p,i,(function(){return this}));var v=Object.getPrototypeOf,y=v&&v(v(values([])));y&&y!==t&&n.call(y,i)&&(p=y);var l=GeneratorFunctionPrototype.prototype=Generator.prototype=Object.create(p);function s(e){return Object.setPrototypeOf?Object.setPrototypeOf(e,GeneratorFunctionPrototype):(e.__proto__=GeneratorFunctionPrototype,define(e,a,"GeneratorFunction")),e.prototype=Object.create(l),e}return GeneratorFunction.prototype=GeneratorFunctionPrototype,define(l,"constructor",GeneratorFunctionPrototype),define(GeneratorFunctionPrototype,"constructor",GeneratorFunction),GeneratorFunction.displayName=define(GeneratorFunctionPrototype,a,"GeneratorFunction"),defineIteratorMethods(l),define(l,a,"Generator"),define(l,i,(function(){return this})),define(l,"toString",(function(){return"[object Generator]"})),(_regenerator=function(){return{w:f,m:s}})()}',
    {
      ...
      dependencies: {
        ...
        regeneratorValues: [
          "body.0.body.body.1.body.body.1.argument.expressions.0.arguments.2.callee.body.body.4.declarations.0.init.properties.7.value.body.body.0.argument.expressions.0.right.properties.0.value.callee",
          "body.0.body.body.8.declarations.1.init.right.arguments.0.arguments.0.callee",
        ],
        tryCatch: [
          "body.0.body.body.1.body.body.1.argument.expressions.0.arguments.2.callee.body.body.9.argument.body.body.2.body.consequent.body.1.consequent.body.0.test.object.right.callee",
          "body.0.body.body.1.body.body.1.argument.expressions.0.arguments.2.callee.body.body.9.argument.body.body.2.body.consequent.body.2.expression.expressions.2.left.right.object.right.callee",
