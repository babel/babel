...
const helpers: Record<string, Helper> = {
  ...
  // size: 2685, gzip size: 1230
  regenerator: helper(
    "7.27.0",
    'function _regenerator(){"use strict";\n/*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */var e,t,r=Object.prototype,n=r.hasOwnProperty,o="function"==typeof Symbol?Symbol:{},i=o.iterator||"@@iterator",a=o.toStringTag||"@@toStringTag",u=["next","throw","return"];function f(r,n,o,i){var a=n&&n.prototype instanceof Generator?n:Generator,f=Object.create(a.prototype);return define(f,"_invoke",function(r,n,o){var i,a,f,p=1,s=o||[],l=!1,y=0,d={prev:0,next:0,sent:e,stop:v,abrupt:h,finish:G,delegateYield:function(t,r){return a=values(t),f=e,d.next=r,c}};function v(){return l=!0,i}function G(t){for(var r=s.length-1;!l&&1!==p&&r>=0;--r){var n=s[r],o=d.prev,i=n[1],a=n[2];if(this&&a===t)return y=n[4]||3,f=n[5]===e?n[3]:n[5],n[4]=3,n[5]=e,c;if(n[0]<=o){if(o<i)return y=0,d.sent=t,d.next=i,e;if(o<a)return n[4]=1,n[5]=t,d.next=a,e}}throw p=4,t}function h(e,t){y=e,f=t;for(var r=s.length-1;r>=0;--r){var n=s[r];if(n[0]<=d.prev&&d.prev<n[2]&&!(3===e&&n[0]<=t&&t<=n[2])){var o=n;o[4]=e,o[5]=t,y=0,d.next=o[2];break}}return c}return function(o,s,g){if(3===p)throw Error("Generator is already running");if(4===p){if(1===s)throw g;return{value:e,done:!0}}for(y=s,f=g;;){a||(0===y?d.sent=f:1===y?G(f):2===y?(i=f,d.next=-1,h(2,f)):d.next=f);try{if(a){if(t=a[u[y]]){if(t=t.call(a,f)){if(!t)throw TypeError("iterator result is not an object");if(!t.done)return t;2!==y&&(y=0,f=t.value)}}else 1===y&&(t=a.return)&&t.call(a),2!==y&&(f=TypeError("The iterator does not provide a \'"+u[y=1]+"\' method"));a=e}else if(p=3,t=(-1===d.next?v:r).call(n,d),p=l?4:2,t!==c)return{value:t,done:l}}catch(t){p=4,a=e,y=1,f=t}}}}(r,o,i),!0),f}var c={};function Generator(){}function GeneratorFunction(){}function GeneratorFunctionPrototype(){}var p={};define(p,i,(function(){return this}));var s=Object.getPrototypeOf,l=s&&s(s(values([])));l&&l!==r&&n.call(l,i)&&(p=l);var y=GeneratorFunctionPrototype.prototype=Generator.prototype=Object.create(p);function d(e){return Object.setPrototypeOf?Object.setPrototypeOf(e,GeneratorFunctionPrototype):(e.__proto__=GeneratorFunctionPrototype,define(e,a,"GeneratorFunction")),e.prototype=Object.create(y),e}return GeneratorFunction.prototype=GeneratorFunctionPrototype,define(y,"constructor",GeneratorFunctionPrototype),define(GeneratorFunctionPrototype,"constructor",GeneratorFunction),GeneratorFunction.displayName=define(GeneratorFunctionPrototype,a,"GeneratorFunction"),defineIteratorMethods(y),define(y,a,"Generator"),define(y,i,(function(){return this})),define(y,"toString",(function(){return"[object Generator]"})),(_regenerator=function(){return{w:f,m:d}})()}',
    {
