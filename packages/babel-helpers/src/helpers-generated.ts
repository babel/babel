...
const helpers: Record<string, Helper> = {
  ...
  // size: 338, gzip size: 242
  get: helper(
    "7.0.0-beta.0",
    'import _superPropBase from"superPropBase";export default function _get(...e){let t=_get;return t="undefined"!=typeof Reflect&&Reflect.get?Reflect.get.bind(null):function(e,t,r){var p=_superPropBase(e,t);if(p){var l=Object.getOwnPropertyDescriptor(p,t);return l&&l.get?l.get.call(arguments.length<3?e:r):l?l.value:void 0}},t.apply(this,e)}',
  ),
  ...
  // size: 609, gzip size: 318
  set: helper(
    "7.0.0-beta.0",
    'import defineProperty from"defineProperty";import superPropBase from"superPropBase";function set(e,r,t,o){var f=set;return f="undefined"!=typeof Reflect&&Reflect.set?Reflect.set:function(e,r,t,o){var f,i=superPropBase(e,r);if(i){if((f=Object.getOwnPropertyDescriptor(i,r))&&f.set)return f.set.call(o,t),!0;if(!f||!f.writable)return!1}if(f=Object.getOwnPropertyDescriptor(o,r)){if(!f.writable)return!1;f.value=t,Object.defineProperty(o,r,f)}else defineProperty(o,r,t);return!0},f(e,r,t,o)}export default function _set(e,r,t,o,f=!1){if(!set(e,r,t,o||e)&&f)throw new TypeError("failed to set property");return t}',
  ),
