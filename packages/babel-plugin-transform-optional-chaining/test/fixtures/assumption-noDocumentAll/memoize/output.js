function test(foo) {
  ...
  (_foo$bar10 = foo.bar) == null || (_foo$bar10$baz = _foo$bar10.baz) == null || _foo$bar10$baz.call(_foo$bar10, foo.bar, false);
  foo == null || (_foo$bar11 = foo.bar) == null || (_foo$bar11$baz = _foo$bar11.baz) == null || _foo$bar11$baz.call(_foo$bar11, foo.bar, true);
}
