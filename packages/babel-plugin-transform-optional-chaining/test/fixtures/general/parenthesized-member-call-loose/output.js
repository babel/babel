class Foo {
  ...
  test() {
    ...
    ((_fn$Foo$self$getSelf = ((_fn = fn()) == null || (_fn$Foo = _fn.Foo) == null ? void 0 : _fn$Foo.self.getSelf.bind(_fn$Foo.self))()) == null ? void 0 : _fn$Foo$self$getSelf.m.bind(_fn$Foo$self$getSelf))();
