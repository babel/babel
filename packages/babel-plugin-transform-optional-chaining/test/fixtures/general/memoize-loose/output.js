function test(foo) {
  ...
  foo.bar == null || foo.bar(foo.bar, false);
  foo == null || foo.bar == null || foo.bar(foo.bar, true);
  (_foo$bar6 = foo.bar) == null || _foo$bar6.baz(foo.bar, false);
  foo == null || (_foo$bar7 = foo.bar) == null || _foo$bar7.baz(foo.bar, true);
  (_foo$bar8 = foo.bar) == null || _foo$bar8.baz == null || _foo$bar8.baz(foo.bar, false);
  foo == null || (_foo$bar9 = foo.bar) == null || _foo$bar9.baz == null || _foo$bar9.baz(foo.bar, true);
}
