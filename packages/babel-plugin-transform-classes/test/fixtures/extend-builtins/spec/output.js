...
function _construct(Parent, args, Class) { if (typeof Reflect !== "undefined" && Reflect.construct) { _construct = function _construct(Parent, args, Class) { if (Class === undefined) return Reflect.construct(Parent, args); var result = Reflect.construct.apply(null, arguments); if (!(result instanceof Class)) result = _setPrototypeOf(result, Class.prototype); return result; }; } else { _construct = function _construct(Parent, args, Class) { var Constructor, a = [null]; a.push.apply(a, args); Constructor = Parent.bind.apply(Parent, a); return _setPrototypeOf(new Constructor(), Class.prototype); }; } return _construct.apply(null, arguments); }
