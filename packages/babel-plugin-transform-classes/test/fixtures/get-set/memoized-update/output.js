...
let Obj = /*#__PURE__*/function (_Base) {
  ...
  return babelHelpers.createClass(Obj, [{
    ...
    value: function update() {
      ...
      babelHelpers.superPropertySet(Obj, _proper$prop = proper.prop, (_super$proper$prop = babelHelpers.superPropertyGetCall(Obj, _proper$prop, this, 1), _super$proper$prop2 = _super$proper$prop++, _super$proper$prop), this, 1, 1), _super$proper$prop2;
    }
  }, {
    key: "update2",
    value: function update2() {
      var _i, _super$i, _super$i2;
      babelHelpers.superPropertySet(Obj, _i = i, (_super$i = babelHelpers.superPropertyGetCall(Obj, _i, this, 1), _super$i2 = _super$i++, _super$i), this, 1, 1), _super$i2;
    }
  }]);
}(Base);
const obj = new Obj();
