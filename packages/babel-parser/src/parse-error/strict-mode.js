...
export default toParseErrorClasses(_ => {
  ...
  StrictEvalArguments: _<{ binding: string }>(({ binding }) => `Assigning to '${binding}' in strict mode.`),
  StrictEvalArgumentsBinding: _<{ binding: string }>(({ binding }) => `Binding '${binding}' in strict mode.`),
