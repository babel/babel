...
class Foo {
  ...
  static test() {
    ...
    (_ref0 = fn == null ? void 0 : babelHelpers.assertClassBrand(Foo, fn().Foo, _self)._) == null ? void 0 : babelHelpers.assertClassBrand(Foo, _ref0$getSelf = _ref0.getSelf(), _m)._.call(_ref0$getSelf);
    (_getSelf4 = (_ref1 = fn == null ? void 0 : babelHelpers.assertClassBrand(Foo, fn().Foo, _self)._)?.getSelf) == null ? void 0 : babelHelpers.assertClassBrand(Foo, _getSelf4$call = _getSelf4.call(_ref1), _m)._.call(_getSelf4$call);
    (_ref10 = fn == null ? void 0 : babelHelpers.assertClassBrand(Foo, fn().Foo, _self)._.getSelf()) == null ? void 0 : babelHelpers.assertClassBrand(Foo, _ref10$self = _ref10.self, _m)._.call(_ref10$self);
    (_call2 = (fn == null ? void 0 : (_babelHelpers$assertC0 = babelHelpers.assertClassBrand(Foo, fn().Foo, _self)._).getSelf)?.call(_babelHelpers$assertC0)) == null ? void 0 : babelHelpers.assertClassBrand(Foo, _call2$self = _call2.self, _m)._.call(_call2$self);
