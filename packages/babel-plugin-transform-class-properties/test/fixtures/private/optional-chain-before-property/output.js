...
class Foo {
  ...
  static test() {
    ...
    (_getSelf4 = (_ref1 = fn === null || fn === void 0 ? void 0 : babelHelpers.assertClassBrand(Foo, fn().Foo, _self)._)?.getSelf) === null || _getSelf4 === void 0 ? void 0 : babelHelpers.assertClassBrand(Foo, _getSelf4.call(_ref1), _x)._;
