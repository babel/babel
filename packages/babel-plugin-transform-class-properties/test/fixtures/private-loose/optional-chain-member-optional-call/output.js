...
class Foo {
  ...
  static test() {
    ...
    (o === null || o === void 0 ? void 0 : babelHelpers.classPrivateFieldLoose(_babelHelpers$classPr = babelHelpers.classPrivateFieldLoose(o.Foo, _self), _m))?.call(_babelHelpers$classPr);
    (o === null || o === void 0 ? void 0 : babelHelpers.classPrivateFieldLoose(_babelHelpers$classPr2 = babelHelpers.classPrivateFieldLoose(o.Foo, _self).self, _m))?.call(_babelHelpers$classPr2);
    ...
    (o === null || o === void 0 ? void 0 : babelHelpers.classPrivateFieldLoose(_babelHelpers$classPr3 = babelHelpers.classPrivateFieldLoose(o.Foo, _self).getSelf(), _m))?.call(_babelHelpers$classPr3);
    (_ref3 = o === null || o === void 0 ? void 0 : (_babelHelpers$classPr4 = babelHelpers.classPrivateFieldLoose(o.Foo, _self)).getSelf) === null || _ref3 === void 0 ? void 0 : (_ref3.call(_babelHelpers$classPr4))[_m]?.();
    ...
    (_call = (o === null || o === void 0 ? void 0 : (_babelHelpers$classPr5 = babelHelpers.classPrivateFieldLoose(o.Foo, _self)).getSelf)?.call(_babelHelpers$classPr5)) === null || _call === void 0 ? void 0 : _call.self[_m]?.();
    ...
    (fn === null || fn === void 0 ? void 0 : babelHelpers.classPrivateFieldLoose(_babelHelpers$classPr6 = babelHelpers.classPrivateFieldLoose(fn().Foo, _self), _m))?.call(_babelHelpers$classPr6);
    (fn === null || fn === void 0 ? void 0 : babelHelpers.classPrivateFieldLoose(_babelHelpers$classPr7 = babelHelpers.classPrivateFieldLoose(fn().Foo, _self).self, _m))?.call(_babelHelpers$classPr7);
    ...
    (fn === null || fn === void 0 ? void 0 : babelHelpers.classPrivateFieldLoose(_babelHelpers$classPr8 = babelHelpers.classPrivateFieldLoose(fn().Foo, _self).getSelf(), _m))?.call(_babelHelpers$classPr8);
    (_ref9 = fn === null || fn === void 0 ? void 0 : (_babelHelpers$classPr9 = babelHelpers.classPrivateFieldLoose(fn().Foo, _self)).getSelf) === null || _ref9 === void 0 ? void 0 : (_ref9.call(_babelHelpers$classPr9))[_m]?.();
    ...
    (_call2 = (fn === null || fn === void 0 ? void 0 : (_babelHelpers$classPr10 = babelHelpers.classPrivateFieldLoose(fn().Foo, _self)).getSelf)?.call(_babelHelpers$classPr10)) === null || _call2 === void 0 ? void 0 : _call2.self[_m]?.();
