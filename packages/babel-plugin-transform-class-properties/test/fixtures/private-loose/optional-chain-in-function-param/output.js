...
class Foo {
  ...
  static test() {
    ...
    function g(o, r = (() => o === null || o === void 0 ? void 0 : babelHelpers.assertClassBrandLoose(babelHelpers.assertClassBrandLoose(o.Foo, _self, 1).getSelf(), _m, 1))()?.()) {
      return r;
    }
    ...
    function i(fn, r = (_getSelf => (_getSelf = (() => fn === null || fn === void 0 ? void 0 : babelHelpers.assertClassBrandLoose(fn().Foo, _self, 1))()?.getSelf()) === null || _getSelf === void 0 ? void 0 : _getSelf.self[_m]())()) {
      return r;
    }
    function j(fn, r = (() => babelHelpers.assertClassBrandLoose(fn().Foo, _self, 1).getSelf().self[_m]?.())()) {
      return r;
    }
    f(o);
    g(o);
