...
describe("api", function () {
  ...
  it("transformFile", function (done) {
    babel.transformFile(__dirname + "/fixtures/api/file.js", { babelrc: false }, function (err, res) {
  ...
  it("transformFileSync", function () {
    assert.equal(babel.transformFileSync(__dirname + "/fixtures/api/file.js", { babelrc: false }).code, "foo();");
  });
