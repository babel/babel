...
function _regeneratorAsyncGen(e, n, r, t, o) { return new function e(n, r) { function t(e, o, i, f) { try { var u = n[e](o), a = u.value; return a instanceof _OverloadYield ? r.resolve(a.v).then(function (e) { t("next", e, i, f); }, function (e) { t("throw", e, i, f); }) : r.resolve(a).then(function (e) { u.value = e, i(u); }, function (e) { return t("throw", e, i, f); }); } catch (e) { f(e); } } var o; this.next || (_regeneratorDefine(e.prototype), _regeneratorDefine(e.prototype, "function" == typeof Symbol && Symbol.asyncIterator || "@asyncIterator", function () { return this; })), _regeneratorDefine(this, "_invoke", function (e, n, i) { function f() { return new r(function (n, r) { t(e, i, n, r); }); } return o = o ? o.then(f, f) : f(); }, !0); }(_regenerator().w(e, n, r, t), o || Promise); }
