...
var debug = buildDebug("babel:config:config-chain");
...
export var buildPresetChainWalker = makeChainWalker({
  ...
  return babelHelpers.regenerator().w(function (_context2) {
    while (1) switch (_context2.n) {
      ...
      case 3:
        ...
        return _context2.d(babelHelpers.regeneratorValues(loadConfig(opts.configFile, context.cwd, context.envName, context.caller)), 4);
      case 4:
      ...
      case 5:
        ...
        return _context2.d(babelHelpers.regeneratorValues(findRootConfig(context.root, context.envName, context.caller)), 6);
      case 6:
        configFile = _context2.v;
      case 7:
      ...
      case 11:
        ...
        return _context2.d(babelHelpers.regeneratorValues(findPackageData(context.filename)), 12);
      case 12:
        pkgData = _context2.v;
        ...
        return _context2.d(babelHelpers.regeneratorValues(findRelativeConfig(pkgData, context.envName, context.caller)), 13);
      case 13:
...
function mergeExtendsChain(chain, opts, dirname, context, files, baseLogger) {
  ...
  return babelHelpers.regenerator().w(function (_context5) {
    while (1) switch (_context5.n) {
      ...
      case 1:
        return _context5.d(babelHelpers.regeneratorValues(loadConfig(opts.extends, dirname, context.envName, context.caller)), 2);
      case 2:
        file = _context5.v;
        if (!files.has(file)) {
          _context5.n = 3;
