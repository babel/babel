...
import codeFrameNode, {
  codeFrameColumns as codeFrameColumnsNode,
  highlight as highlightNode,
} from "../lib/index.js";
import codeFrameBrowser, {
  codeFrameColumns as codeFrameColumnsBrowser,
  highlight as highlightBrowser,
} from "../lib/browser.js";

for (const { name, codeFrame, codeFrameColumns, highlight } of [
  {
    name: "node",
    codeFrame: codeFrameNode,
    codeFrameColumns: codeFrameColumnsNode,
    highlight: highlightNode,
  },
  {
    name: "browser",
    codeFrame: codeFrameBrowser,
    codeFrameColumns: codeFrameColumnsBrowser,
    highlight: highlightBrowser,
  },
]) {
  describe(`@babel/code-frame(${name})`, function () {
