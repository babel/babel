...
function compile(code, filename) {
  ...
  const optionsMangerInstance =
    cache &&
    cache[registerCache.OPTIONS_MANAGER_CACHE_KEY] instanceof
      babel.OptionManager
      ? cache[registerCache.OPTIONS_MANAGER_CACHE_KEY]
      : new OptionManager();
  const opts = optionsMangerInstance.init(
