...
export const ArrayExpression = alias("arrayExpression"),
  ...
  RestPlaceholder = alias("restPlaceholder"),
  PartialCallExpression = alias("partialCallExpression"),
  PartialNewExpression = alias("partialNewExpression"),
  OptionalPartialCallExpression = alias("optionalPartialCallExpression"),
