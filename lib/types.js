...
declare module "babel-types" {
  ...
  declare function binaryExpression(operator: string, left: BabelNodeExpression, right: BabelNodeExpression): BabelNodeBinaryExpression;
  ...
  declare function switchCase(test: any, consequent: any): BabelNodeSwitchCase;
  declare function switchStatement(discriminant: any, cases: any): BabelNodeSwitchStatement;
  ...
  declare function unaryExpression(prefix?: boolean, argument: BabelNodeExpression, operator: any): BabelNodeUnaryExpression;
  declare function updateExpression(prefix?: boolean, argument: BabelNodeExpression, operator: any): BabelNodeUpdateExpression;
  ...
  declare function exportAllDeclaration(source: any): BabelNodeExportAllDeclaration;
  declare function exportDefaultDeclaration(declaration: any): BabelNodeExportDefaultDeclaration;
  declare function exportNamedDeclaration(declaration: any, specifiers: any, source: any): BabelNodeExportNamedDeclaration;
