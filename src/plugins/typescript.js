...
export default (superClass: Class<Parser>): Class<Parser> => class extends superClass {
  ...
  tsParsePropertyOrMethodSignature(
    ...
    readonly: boolean): N.TsPropertySignature | N.TsMethodSignature {
  ...
  tsParseFunctionOrConstructorType(
    type: "TSFunctionType" | "TSConstructorType"): N.TsFunctionOrConstructorType {
  ...
  tsParseType(): N.TsType {
    ...
    try {
      ...
      if (this.match(tt._new)) { // As in `new () => Date`
  ...
  tsParseModuleBlock(): N.TsModuleBlock {
    ...
    this.parseBlockOrModuleBlockBody(
      node.body = [], /* directives */ undefined, /* topLevel */ true, /* end */ tt.braceR);
  ...
  tsParseImportEqualsDeclaration(
    ...
    isExport?: boolean): N.TsImportEqualsDeclaration {
  ...
  parseAssignableListItem(
    ...
    decorators: N.Decorator[]): N.Pattern | N.TSParameterProperty {
  ...
  parseFunctionBodyAndFinish(
    ...
    type: string,
    allowExpressionBody?: boolean): void {
  ...
  parseSubscript(
    ...
    startLoc: Position,
    noCalls: ?boolean,
    state: { stop: boolean }): N.Expression {
    ...
    if (!noCalls && this.isRelational("<")) {
      ...
      if (typeArguments) {
        ...
        node.arguments = this.parseCallExpressionArguments(tt.parenR, /* possibleAsync */ false);
  ...
  */
  ...
  parseExport(node: N.Node): N.Node {
    if (this.match(tt._import)) { // `export import A = B;`
      this.expect(tt._import);
      return this.tsParseImportEqualsDeclaration(node, /* isExport */ true);
    } else if (this.eat(tt.eq)) { // `export = x;`
      const assign: N.TsExportAssignment = node;
      assign.expression = this.parseExpression();
      this.semicolon();
      return this.finishNode(assign, "TSExportAssignment");
    } else if (this.eatContextual("as")) { // `export as namespace A;`
  ...
  parseClassMember(classBody: N.ClassBody, member: any, state: { hadConstructor: boolean }): void {
  ...
  parseClassMemberWithIsStatic(
    ...
    let abstract = false, readonly = false;
  ...
  parseAsyncArrowFromCallExpression(
    ...
    call: N.CallExpression): N.ArrowFunctionExpression {
  ...
  toAssignableList(
    ...
    isBinding: ?boolean,
    contextDescription: string): $ReadOnlyArray<N.Pattern> {
