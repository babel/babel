...
- _In the system that output code generated by Babel runs in_
  - Any side effect or availability loss or performance degradation, other than what's expected according the documented behavior of the language features used in the input code provided to Babel
