...
test-flow:
	yarn node scripts/parser-tests/flow

test-flow-ci: build-bundle-ci bootstrap-flow
	$(MAKE) test-flow

test-flow-update-whitelist:
	yarn node scripts/parser-tests/flow --update-whitelist
...
test-typescript-update-whitelist:
	yarn node scripts/parser-tests/typescript --update-whitelist
...
test-test262:
	yarn node scripts/parser-tests/test262

test-test262-ci: build-bundle-ci bootstrap-test262
	$(MAKE) test-test262

test-test262-update-whitelist:
	yarn node scripts/parser-tests/test262 --update-whitelist
