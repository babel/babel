...
lint:
	./node_modules/.bin/eslint scripts $(SOURCES) --format=codeframe --rulesdir="./scripts/eslint_rules"

fix:
	./node_modules/.bin/eslint scripts $(SOURCES) --format=codeframe --fix --rulesdir="./scripts/eslint_rules"
